...
/// <summary>
/// A minimal JSON reader for the Mojang data reports.
/// </summary>
/// <remarks>
/// A source generator referenced as a project does not get its NuGet dependencies
/// loaded alongside it, so a JSON library cannot be used here. The reports only
/// contain objects, strings, numbers and booleans, which keeps this small.
/// </remarks>
...
internal class JsonObject : Dictionary<string, object?>
{
    ...
    public int? GetInt(string name)
        => TryGetValue(name, out var value) && value is double number ? (int)number : null;
}
